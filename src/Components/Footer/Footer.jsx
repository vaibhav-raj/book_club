...
import summit_profile from '../../Assets/Images/sumit_profile.jfif'
...
const Footer = () => {
    return (
        <>
            <div style={{ marginTop: "120px", padding: "20px", background: "#222831" }}>
                <Row>
                    <Col className={`${styles.wrapper} ${"mx-4"} ${"my-2"}`} sm>
                    ...
                    <Col className={`${styles.wrapper} ${"mx-4"} ${"my-2"}`} sm>
                        <div className={styles.footer_profile}>
                            <div><img className={styles.profile_tag} src={summit_profile} alt="" /></div>
                        </div>
                        <div className={styles.profile_name_div}>
                            <div className={styles.profile_div}>
